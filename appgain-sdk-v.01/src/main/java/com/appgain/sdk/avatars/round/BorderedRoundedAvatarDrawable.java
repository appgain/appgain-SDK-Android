package com.appgain.sdk.avatars.round;
...
import com.appgain.sdk.avatars.AvatarBorder;

/**
 * A Drawable that draws an oval with given {@link Bitmap} adding a border with a given
 * color and width
 */

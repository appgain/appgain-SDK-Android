...
import io.appgain.sdk.LandingPages.RequestModels.ComponentsModels.ButtonType;
import io.appgain.sdk.LandingPages.RequestModels.ComponentsModels.Component;
import io.appgain.sdk.LandingPages.RequestModels.ComponentsModels.DeepPageComponentCreator;
import io.appgain.sdk.LandingPages.RequestModels.ComponentsModels.InfoImage;
import io.appgain.sdk.LandingPages.RequestModels.ComponentsModels.DeepPageHeader;
import io.appgain.sdk.LandingPages.RequestModels.ComponentsModels.DeepPageContent;
import io.appgain.sdk.LandingPages.RequestModels.ComponentsModels.InfoSLider;
import io.appgain.sdk.LandingPages.RequestModels.SocialMedia;
...
public class LandingPage {
    ...
    public static final  class Builder implements Serializable{
        ...
        @NonNull
        public Builder withLang(@NonNull String lang) {
            this.lang = lang;
            return  this ;
        }

        @NonNull
        public Builder withWebPushSubscription(@NonNull boolean webPushSubscription) {
            this.webPushSubscription = webPushSubscription;
            return  this ;
        }
        @NonNull
        public Builder withHeatMapTracking(@NonNull boolean heatMapTracking) {
            this.heatMapTracking = heatMapTracking;
            return  this ;
        }

        @NonNull
        public Builder withHeader(@NonNull String logo , String topic ) {
        ...
        @NonNull
        public Builder withButton(@NonNull String text , String web , String android, String ios) {
        ...
        @NonNull
        public Builder withInfo(@NonNull String imageUrl) {
        ...
        @NonNull
        public Builder withInfo(String... imagesUrls) {
        ...
        @NonNull
        public Builder withInfo(int speed, int autoPlay, int spacebetween, boolean watchSlidesProgress, InfoSLider.SliderEffects effect, InfoSLider.SliderDirection direction , String... imagesUrls) {
            this.imageDefault =false;
        ...
        @NonNull
        public Builder withInfo(InfoSLider slider) {
            this.imageDefault =false;
        ...
        @NonNull
        public Builder withSocialMedia(@NonNull String title  , @NonNull String description  , @NonNull String image) {

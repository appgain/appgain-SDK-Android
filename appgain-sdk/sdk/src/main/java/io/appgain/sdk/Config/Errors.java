...
public class Errors {
    ...
    public static final String DEEP_PAGE_SM = Errors.DEEP_PAGE + " social media";

    public static String SMART_LINK_NAME = SNART_DEEP_LINK+" Name ";
    public static String DEEP_PAGE_LABEL = DEEP_PAGE+" Label ";
    ...
    public static final String DEEP_PAGE_SLUG_REGX_ERROR = DEEP_PAGE+" Slug must be from 5 to 100 character ";
    public static final String SMART_LINK_SLUG_CANNOT_CONTAINS = SNART_DEEP_LINK+" Slug Cannot Contains: ";
    public static final String DEEP_PAGE_SLUG_CANNOT_CONTAINS = DEEP_PAGE+" Slug Cannot Contains: ";
    ...
    public static String DEEP_PAGE_SM_DESCRIPTION = DEEP_PAGE+" social Media Description ";
    public static String SMART_LINK_SM_IMAGE = SNART_DEEP_LINK+" social Media Image ";
    public static String DEEP_PAGE_SM_IMAGE = DEEP_PAGE+" social Media Image ";
